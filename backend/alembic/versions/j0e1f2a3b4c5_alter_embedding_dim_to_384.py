...
def upgrade() -> None:
    ...
    op.alter_column("pms_product_embeddings", "model_name", server_default="all-MiniLM-L6-v2")
...
def downgrade() -> None:
    ...
    op.alter_column("pms_product_embeddings", "model_name", server_default="text-embedding-3-small")
