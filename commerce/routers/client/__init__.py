"""C端 /api/client/v1 — shared router."""

from fastapi import APIRouter

from commerce.routers.client import (
    auth_router,
    user_router,
    home_router,
    merchant_router,
...
router.include_router(misc_routers.fav_router, tags=["客户端-收藏"])
router.include_router(misc_routers.search_router, tags=["客户端-搜索"])
router.include_router(misc_routers.review_router, tags=["客户端-评价"])
