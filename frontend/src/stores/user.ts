...
const DEFAULT_MENUS: MenuItem[] = [
  { id: "1", parentId: "", title: '商品管理', name: 'pms', icon: 'Goods', sort: 5, hidden: 0 },
  ...
  { id: "6", parentId: "", title: '订单管理', name: 'oms', icon: 'Document', sort: 4, hidden: 0 },
  ...
  { id: "10", parentId: "", title: '会员管理', name: 'ums', icon: 'User', sort: 3, hidden: 0 },
  ...
  { id: "18", parentId: "", title: '营销管理', name: 'sms', icon: 'Promotion', sort: 2, hidden: 0 },
  ...
  { id: "22", parentId: "", title: '内容管理', name: 'cms', icon: 'DocumentCopy', sort: 1, hidden: 0 },
  ...
  { id: "25", parentId: "", title: '系统设置', name: 'setting', icon: 'Tools', sort: 0, hidden: 0 },
...
export const useUserStore = defineStore('user', () => {
  ...
  async function login(form: LoginForm) {
    ...
    const { accessToken, refreshToken } = loginRes.data as unknown as { accessToken: string; refreshToken: string }
    ...
    try {
      ...
      // 响应拦截器已将 snake_case 转换为 camelCase
      const me = meRes.data as unknown as { email: string; nickname: string | null; avatarUrl: string | null }
